...
int main(int argc, char** argv) {
   ...
   TH1F* h_stub3_bx124_slow_wrongU = new TH1F("h_stub3_bx124_slow_wrongU", "h_stub3_bx124_slow_wrongU", binnum_mediumpt, bins_mediumpt); h_stub3_bx124_slow_wrongU->Sumw2();
   TH1F* h_stub3_bx124_slow_wrongD = new TH1F("h_stub3_bx124_slow_wrongD", "h_stub3_bx124_slow_wrongD", binnum_mediumpt, bins_mediumpt); h_stub3_bx124_slow_wrongD->Sumw2();
   TH1F* h_stub3_bx124_slow_fail = new TH1F("h_stub3_bx124_slow_fail", "h_stub3_bx124_slow_fail", binnum_mediumpt, bins_mediumpt); h_stub3_bx124_slow_fail->Sumw2();
   TH1F* h_stub3_bx124_slow_wrong_fail = new TH1F("h_stub3_bx124_slow_wrong_fail", "h_stub3_bx124_slow_wrong_fail", binnum_mediumpt, bins_mediumpt); h_stub3_bx124_slow_wrong_fail->Sumw2();
   TH1F* h_stub3_bx124_slow_wrongU_fail = new TH1F("h_stub3_bx124_slow_wrongU_fail", "h_stub3_bx124_slow_wrongU_fail", binnum_mediumpt, bins_mediumpt); h_stub3_bx124_slow_wrongU_fail->Sumw2();
   TH1F* h_stub3_bx124_slow_wrongD_fail = new TH1F("h_stub3_bx124_slow_wrongD_fail", "h_stub3_bx124_slow_wrongD_fail", binnum_mediumpt, bins_mediumpt); h_stub3_bx124_slow_wrongD_fail->Sumw2();
   ...
   TH1F* h_stub4_bx123 = new TH1F("h_stub4_bx123", "h_stub4_bx123", binnum_mediumpt, bins_mediumpt); h_stub4_bx123->Sumw2();
   TH1F* h_stub4_bx123_wrong = new TH1F("h_stub4_bx123_wrong", "h_stub4_bx123_wrong", binnum_mediumpt, bins_mediumpt); h_stub4_bx123_wrong->Sumw2();
   TH1F* h_stub4_bx123_wrongU = new TH1F("h_stub4_bx123_wrongU", "h_stub4_bx123_wrongU", binnum_mediumpt, bins_mediumpt); h_stub4_bx123_wrongU->Sumw2();
   TH1F* h_stub4_bx123_wrongD = new TH1F("h_stub4_bx123_wrongD", "h_stub4_bx123_wrongD", binnum_mediumpt, bins_mediumpt); h_stub4_bx123_wrongD->Sumw2();
   TH1F* h_stub4_bx123_neutron = new TH1F("h_stub4_bx123_neutron", "h_stub4_bx123_neutron", binnum_mediumpt, bins_mediumpt); h_stub4_bx123_neutron->Sumw2();
   TH1F* h_stub4_bx123_fail = new TH1F("h_stub4_bx123_fail", "h_stub4_bx123_fail", binnum_mediumpt, bins_mediumpt); h_stub4_bx123_fail->Sumw2();
   TH1F* h_stub4_bx123_wrong_fail = new TH1F("h_stub4_bx123_wrong_fail", "h_stub4_bx123_wrong_fail", binnum_mediumpt, bins_mediumpt); h_stub4_bx123_wrong_fail->Sumw2();
   TH1F* h_stub4_bx123_wrongU_fail = new TH1F("h_stub4_bx123_wrongU_fail", "h_stub4_bx123_wrongU_fail", binnum_mediumpt, bins_mediumpt); h_stub4_bx123_wrongU_fail->Sumw2();
   TH1F* h_stub4_bx123_wrongD_fail = new TH1F("h_stub4_bx123_wrongD_fail", "h_stub4_bx123_wrongD_fail", binnum_mediumpt, bins_mediumpt); h_stub4_bx123_wrongD_fail->Sumw2();
