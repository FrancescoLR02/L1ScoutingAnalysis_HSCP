...
./ZmumuAnalysis.exe $INDIR/DY_Skim_SIM.root  $OUTDIR/DY_SIM.root            DY       KBMTF
#./ZmumuAnalysis.exe $INDIR/modZmumuSim.root  $OUTDIR/DYall.root         DYall    KBMTF
./ZmumuAnalysis.exe $INDIR/DY_Skim.root $OUTDIR/DY_SIM.root data_obs KBMTF
python3 Create_fake_Zmumu.py --selection="ZmumuKBMTF"
hadd -f $OUTDIR/datacard_ZmumuKBMTF.root $OUTDIR/DY.root $OUTDIR/DY.root $OUTDIR/Fake.root
