...
int GetIndexByCharge(int wantPos, int ncand, ROOT::VecOps::RVec<Float_t> &LepCand_hwK, ROOT::VecOps::RVec<Float_t> &LepCand_eta, ROOT::VecOps::RVec<Float_t> &LepCand_phi, ROOT::VecOps::RVec<Short_t> &nstub);
